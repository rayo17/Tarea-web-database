...
namespace API_Rest.Controllers
{
    ...
    public class ReservacionController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateReservacion(int cedula, int idProc, [FromBody] PostReservacion reservacion)
        {
            ...
            using (var command = new SqliteCommand(query, (SqliteConnection?)_context.Database.GetDbConnection()))
            {
                command.Parameters.AddWithValue("@fecha", reservacion.Fecha);
                command.Parameters.AddWithValue("@cedula", cedula);
                command.Parameters.AddWithValue("@idProc", reservacion.Id_proc);
